...
public class New_book_Request extends AppCompatActivity {
    ...
    public void FetchURL() {
        ...
        mDatabase.child("NewBookRequest").addValueEventListener(new ValueEventListener() {
            @Override
...
//            Check if the device is connected to internet through Wi-Fi or Mobile Network
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_book_request);
